...
public class CiosController {
    ...
    public ResponseEntity<Object> searchContent(@RequestBody SearchCriteria searchCriteria) {
    ...
    public ResponseEntity<Object> readContent(@RequestBody SearchCriteria searchCriteria) {
